...
$msg="This email or Contact Number already associated with another account";
    ...
    echo$query=mysqli_query($con, "insert into tbluser(FullName,Email,MobileNumber,StudentID,Gender,Password) values('$fullname','$email','$mobno','$stuid','$gender','$password')");
    if ($query) {
